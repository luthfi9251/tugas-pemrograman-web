			...
			<table class="table table-bordered">
				...
				<tr>
					...
					<td>
							...
							<a href="hapus_user.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('anda yakin ingin hapus?');">Hapus</a>
					</td>
				</tr>
...
$(document).ready(function() {
    $('.edit-btn').on('click', function() {
        ...
        $('#seg-modal').load('editUser_modal.php?id=' + userID, function() {
            $('#myModal').modal('show');
        });
    });
});
